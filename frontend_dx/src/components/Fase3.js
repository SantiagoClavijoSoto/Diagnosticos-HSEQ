...
const Fase3 = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:8000/fases/3/');
        ...
        <>
            ...
            <div className='padding-content'>
                <div className="text-center my-3">
                    ...
                    <hr className="hr" />
                    <MDBTypography className='fw-bold text-start' variant='h4'>Fase 3. Seguimiento por la organización</MDBTypography>
                </div>
                ...
                <nav aria-label='Page navigation example text-end'>
                    <MDBPagination center className='mb-0 py-4'>
                        <MDBPaginationItem>
                            <MDBPaginationLink href='/fase2' className='color-text-pagination border-button-pagination'>Anterior</MDBPaginationLink>
                        </MDBPaginationItem>
                        <MDBPaginationItem>
                        ...
                        <MDBPaginationItem active aria-current='page'>
                            <MDBPaginationLink href='/fase3' className='bg-button-pagination border-button-pagination'>Fase 3</MDBPaginationLink>
                        </MDBPaginationItem>
                        <MDBPaginationItem>
                            <MDBPaginationLink href='/fase4' className='color-text-pagination border-button-pagination'>Fase 4</MDBPaginationLink>
                        </MDBPaginationItem>
                        <MDBPaginationItem>
                            <MDBPaginationLink href='/fase4' className='color-text-pagination border-button-pagination'>Siguiente</MDBPaginationLink>
                        </MDBPaginationItem>
                    </MDBPagination>
                </nav>
            </div>
