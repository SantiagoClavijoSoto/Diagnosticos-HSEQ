        ...
        <>
            ...
            <div className='padding-content'>
                <div className="text-center my-3">
                    ...
                    <hr className="hr" />
                    <MDBTypography className='fw-bold text-start' variant='h4'>Fase 2. implementación y ejecución del PESV</MDBTypography>
                </div>
                ...
                <nav aria-label='Page navigation example text-end'>
                    <MDBPagination center className='mb-0 py-4'>
                        <MDBPaginationItem>
                            <MDBPaginationLink href='/fase1' className='color-text-pagination border-button-pagination'>Anterior</MDBPaginationLink>
                        </MDBPaginationItem>
                        <MDBPaginationItem>
                            <MDBPaginationLink href='/fase1' className='color-text-pagination border-button-pagination'>Fase 1</MDBPaginationLink>
                        </MDBPaginationItem>
                        <MDBPaginationItem active aria-current='page'>
                            <MDBPaginationLink href='/fase2' className='bg-button-pagination border-button-pagination'>Fase 2</MDBPaginationLink>
                        </MDBPaginationItem>
                        <MDBPaginationItem>
                        ...
                        <MDBPaginationItem>
                            <MDBPaginationLink href='/fase3' className='color-text-pagination border-button-pagination'>Siguiente</MDBPaginationLink>
                        </MDBPaginationItem>
                    </MDBPagination>
                </nav>
            </div>
